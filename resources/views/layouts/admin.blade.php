...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="{{asset('styles/images/favicon.ico')}}" type="image/x-icon">
    <!-- Plugins Core Css -->
    <link href="{{asset('styles/css/app.min.css')}}" rel="stylesheet">
    <!-- Custom Css -->
    <link href="{{asset('styles/css/style.css')}}" rel="stylesheet" />
    <!-- Theme style. You can choose a theme from css/themes instead of get all themes -->
    <link href="{{asset('styles/css/styles/all-themes.css')}}" rel="stylesheet" />
</head>
...
<body>
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                <img class="loading-img-spin" src="{{asset('styles/images/loading.png')}}" width="20" height="20" alt="admin">
            </div>
            <p>Please wait...</p>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="{{asset('styles/images/logo.png')}}" alt="" />
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user1.jpg')}}" alt="">
                                            </span>
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user2.jpg')}}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user3.jpg')}}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user4.jpg')}}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user5.jpg')}}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user6.jpg')}}" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="{{asset('styles/images/user/user7.jpg')}}" alt="">
                                            </span>
                                            <span class="menu-info">
                                                <span class="menu-title">John Doe</span>
                                                <span class="menu-desc">
                    ...
                    <li class="dropdown user_profile">
                        <a href="#" onClick="return false;" class="dropdown-toggle" data-bs-toggle="dropdown"
                            role="button">
                            <img src="{{asset('styles/images/user.jpg')}}" width="32" height="32" alt="User">
                        </a>
                        <ul class="dropdown-menu pullDown">
                            <li class="body">
    ...
    <!-- Plugins Js -->
    <script data-cfasync="false" src="../../../../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{asset('styles/js/app.min.js')}}"></script>
    <script src="{{asset('styles/js/chart.min.js')}}"></script>
    <!-- Custom Js -->
    <script src="{{asset('styles/js/admin.js')}}"></script>
    <script src="{{asset('styles/js/pages/sparkline/sparkline-data.js')}}"></script>
    <script src="{{asset('styles/js/bundles/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('styles/js/pages/index.js')}}"></script>
</body>